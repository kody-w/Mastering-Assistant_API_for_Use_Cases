...
# Define the stock symbol for Tesla, Inc.
symbol = 'TSLA'

# Fetch the historical data for TSLA from the start of the year until today
...
print(f'TSLA YTD Percentage Change: {percentage_change:.2f}%')
